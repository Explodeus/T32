...
public class Dispatcher {
    ...
    private static boolean readFile() {
        ...
        try {
            ...
            for (String line; fileToRead.hasNextLine() && (line = fileToRead.nextLine()) != null; ) {
                ...
                stringBufferOfData.append(line).append("\r\n");//appeneding all text read in from the file to a string buffer which will be used to edit the contents of the file
            }
    ...
    private static void replacement() {
        System.out.println("Please enter the contents of a line you would like to do: ");
        System.out.println("Print edit/new line print");

        String whatToDo = sc.nextLine();//read the line to do smth
        ...
        }else if(whatToDo == "new line print" || whatToDo =="newlineprint"){
            System.out.println("Please enter the new line text:");
            //TODO
        }
